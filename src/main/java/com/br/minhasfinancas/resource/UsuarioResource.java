...
public class UsuarioResource {
	...
	//EU JA TENHO UM POST PARA SALVAR UM USUARIO. PRECISO DE OUTRO POST PARA AUTENTICAR.
	//DESSA FORMA EU PRECISO DAR UM ENDPOINT PARA ESSE POST COMO ABAIXO: @PostMapping("/autenticar")
	...
	public ResponseEntity salvar( @RequestBody UsuarioDTO dto) {
		...
		//OBS:no outro projeto esse cosntrutor foi criado na classe de servico e aqui eu chamava o metodo com esse construtor.
